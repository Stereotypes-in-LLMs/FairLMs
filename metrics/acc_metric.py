...
class AccEvaluator(BaseModel):
    ...
    def predict(self) -> list[dict]:
        ...
        * woman + feminitive
        ...
        acc_man_no_feminitive = self.compute_f1_score(self.sentences_man_no_feminitive)

        print("Starting Accuracy metric evaluation - f1_woman_no_feminitive")
        acc_woman_no_feminitive = 0
        acc_woman_no_feminitive = self.compute_f1_score(self.sentences_woman_no_feminitive)

        print("Starting Accuracy metric evaluation - f1_woman_feminitive")
        acc_woman_feminitive = 0
        acc_woman_feminitive = self.compute_f1_score(self.sentences_woman_feminitive)

        print("Starting Accuracy metric evaluation - f1_feminitive")
        acc_diff_feminitive = self.compute_f1_score_man_woman(self.sentences_man_no_feminitive, self.sentences_woman_feminitive)

        print("Starting Accuracy metric evaluation - f1_no_feminitive")
        acc_diff_no_feminitive = self.compute_f1_score_man_woman(self.sentences_man_no_feminitive, self.sentences_woman_no_feminitive)
